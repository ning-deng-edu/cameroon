	...
	public void testRule() {
		if (rule == null) {
			...
			try {
				...
				assertArrayEquals(new Object[] {"Remove from sentence 1 Remove from sentence 2"},
						runtest("Remove from sentence 1? Remove from sentence 2!"));
				assertArrayEquals(new Object[] {"Anand Remove from sentence 1 Remove from sentence 2"},
						runtest("Anand Remove from sentence 1! Remove from sentence 2!  "));
				...
				assertArrayEquals(new Object[]{"the","search","query","was","em?ty","Jamster's"},
						runtest("the","search","query","was","em?ty","Jamster!'s"));
				...
				assertArrayEquals(new Object[]{"Say", "what","ja"},
						runtest("Say","what??!!!!??","ja"));
