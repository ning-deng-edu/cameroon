...
public class Partitioner {
	...
	//place to store the term in partition mapping. in my case i shd try to replicate a B-Tree structure here
	public static int getNumPartitions() {
		//TODO: Implement this method
		return TermIndex.getNumPartitions();
	}
	...
	public static int getPartitionNumber (String term) {
		...
		return TermIndex.getPartitionNumber(term);
	}
