...
public class WikipediaParserTest {
	...
	/**
	 * Test method for {@link edu.buffalo.cse.ir.wikii`ndexer.wikipedia.WikipediaParser#parseTagFormatting(java.lang.String)}.
	 */
	@Test
	...
	public final void testParseTemplates() {
		...
		assertEquals("Abc ", WikipediaParser.parseTemplates("Abc {{Persondata |NAME = Kay, Kathie" +
